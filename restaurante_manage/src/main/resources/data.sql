...
-- 2. RESTAURANTES
-- ============================================
INSERT INTO restaurants (name, address, phone, email, description, opening_time, closing_time, capacity, public_booking_enabled, default_reservation_duration_minutes, active_under_plan, created_at, updated_at, deleted)
